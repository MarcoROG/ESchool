...
<html lang="it">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <a href="{{url('users/verify/'.$token)}}" class="col s4 offset-s4 center-align btn waves-effect waves-light"><i class="mdi-action-launch right"></i> Attiva il tuo account!</a>
            </div>
        </div>
    </body>
</html>