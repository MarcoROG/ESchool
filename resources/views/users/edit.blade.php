        ...
        <form  role="form" method="POST" action="{{url('users/'.$user->token.'/edit')}}" >
            ...
            <div class="row">
                ...
                <div class="input-field col s5 offset-s1">
                    ...
                    <input type="text" name="name" id="name" maxlength="30" class="validate" value="{{ $user->name }}">
                    <label for="name">Nome</label>
                </div>
                {{--Secondo nome--}}
                <div class="input-field col s5 ">
                    <i class="mdi-social-person prefix"></i>
                    <input type="text" name="middle_name" id="middle_name" maxlength="30" class="validate" value="{{ $user->middle_name }}">
                    <label for="middle_name">Secondo nome</label>
                </div>
                {{--Cognome--}}
                <div class="input-field col s5 offset-s1">
                    <i class="mdi-social-person prefix"></i>
                    <input type="text" name="surname" id="surname" maxlength="30" class="validate" value="{{ $user->surname }}">
            ...
            <div class="row">
                ...
                <div class="input-field col s5 offset-s1">
                    ...
                    <input type="text" class="datepicker picker__input" name="birth_day" id="birth_day" value="{{ $user->birth_day }}">
            ...
            <div class="row">
                ...
                <div class="input-field col s3 offset-s1">
                    ...
                    <input type="radio" name="gender" id="Male" value="M" <?php if($user->gender=="M"){echo 'checked="checked"';} ?>>
                    <label for="Male">Maschio</label>
                </div>
                <div class="input-field col s3 offset-s1">
                    <input type="radio" name="gender" id="Female" value="F" <?php if($user->gender=="F"){echo 'checked="checked"';} ?>>
            ...
            <div class="row">
                ...
                <div class="input-field col offset-s1 s5">
                    ...
                    <input type="tel" name="telephone" id="telephone" class="validate" value="{{ $user->telephone }}">
                    <label for="telephone">Numero di telefono domestico</label>
                </div>
                {{--Cellulare--}}
                <div class="input-field col s5">
                    <i class="mdi-hardware-smartphone prefix"></i>
                    <input type="tel" name="mobile" id="mobile" class="validate" value="{{ $user->mobile }}">
