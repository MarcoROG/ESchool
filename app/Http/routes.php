...
Route::group(['prefix'=>'users', 'middleware'=>['auth','acl']],function(){
    Route::get('/',['uses'=>'UserController@getAll', 'can'=>'view.users']);//Does this make sense? everyone can view an user
    Route::post('/',['uses'=>'UserController@register','can'=>'create.users']);//Does this make sense? the add page is blocked and has a csrf token
